import { ref, defineComponent, provide, onMounted, pushScopeId, popScopeId, openBlock, createBlock, renderSlot, createVNode, withScopeId, inject, getCurrentInstance, watch } from 'vue';
...
script$c.__scopeId = "data-v-4b862892";
...
var script$9 = defineComponent({
    ...
    setup(props) {
        ...
        const vmb_circle = inject('vmb_circle', null);
        const vmb_polygon = inject('vmb_polygon', null);
        const vmb_rectangle = inject('vmb_rectangle', null);
...
var components = /*#__PURE__*/Object.freeze({
  ...
  MapboxMap: script$c,
  MapboxIcon: script$4,
  MapboxMarker: script$b,
  MapboxNavigationControl: script$a,
  MapboxPopup: script$9,
  MapboxAttributionControl: script$8,
  MapboxScaleControl: script$7,
  MapboxFullscreenControl: script$6,
  MapboxSourceGeoJson: script$5,
  MapboxGeolocateControl: script$3,
  MapboxGeogeometryCircle: script$2,
  MapboxGeogeometryPolygon: script$1,
  MapboxGeogeometryRectangle: script
});
...
export { script$8 as MapboxAttributionControl, script$6 as MapboxFullscreenControl, script$2 as MapboxGeogeometryCircle, script$1 as MapboxGeogeometryPolygon, script as MapboxGeogeometryRectangle, script$3 as MapboxGeolocateControl, script$4 as MapboxIcon, script$c as MapboxMap, script$b as MapboxMarker, script$a as MapboxNavigationControl, script$9 as MapboxPopup, script$7 as MapboxScaleControl, script$5 as MapboxSourceGeoJson };
