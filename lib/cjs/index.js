'use strict';Object.defineProperty(exports,'__esModule',{value:true});require('@mapbox/mapbox-gl-geocoder/dist/mapbox-gl-geocoder.css');var vue=require('vue'),Deferred=require('my-deferred/dist/src'),mapboxgl=require('mapbox-gl'),MapboxGeocoder=require('@mapbox/mapbox-gl-geocoder'),Deferred$1=require('my-deferred'),equal=require('fast-deep-equal'),MapboxDrawControl=require('@mapbox/mapbox-gl-draw');require('@mapbox/mapbox-gl-draw/dist/mapbox-gl-draw.css'),require('mapbox-gl/dist/mapbox-gl.css');function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e}}var Deferred__default=/*#__PURE__*/_interopDefaultLegacy(Deferred);var mapboxgl__default=/*#__PURE__*/_interopDefaultLegacy(mapboxgl);var MapboxGeocoder__default=/*#__PURE__*/_interopDefaultLegacy(MapboxGeocoder);var Deferred__default$1=/*#__PURE__*/_interopDefaultLegacy(Deferred$1);var equal__default=/*#__PURE__*/_interopDefaultLegacy(equal);var MapboxDrawControl__default=/*#__PURE__*/_interopDefaultLegacy(MapboxDrawControl);/******************************************************************************
...
};var browserIsSafari = () => navigator.userAgent.toLowerCase().includes('safari') && !navigator.userAgent.toLocaleLowerCase().includes('chrome');const mountGeocoderControl = (vmb_map, vmb_geocoder, props, instance) => __awaiter(void 0, void 0, void 0, function* () {
    const map = vmb_map ? yield vmb_map.promise : null;
    const options = getGeocoderControlOptions(props);
    const geocoder = new MapboxGeocoder__default["default"](options);
...
const getGeocoderControlOptions = (props) => {
    ...
    options.accessToken = props.accessToken || mapboxgl__default["default"].accessToken;
    options.mapboxgl = mapboxgl__default["default"];
    return options;
};
const attachToInput = (ref, geocoder, instance) => {
    ...
    setup(props) {
        ...
        const vmb_geocoder = new Deferred__default["default"]();
        const showOriginalGeocoder = vue.ref(true);
        const geocoderState = vue.ref({
            result: {},
            results: {},
            error: null,
            loading: null,
        ...
        vue.onUnmounted(() => __awaiter(this, void 0, void 0, function* () {
            const geocoder = yield vmb_geocoder.promise;
            if (vmb_map) {
        ...
        vue.watch(props, () => __awaiter(this, void 0, void 0, function* () {
        }));
...
function render$g(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock("div", null, [
    vue.withDirectives(vue.createElementVNode("div", _hoisted_1$8, null, 512), [
      [vue.vShow, _ctx.showOriginalGeocoder]
    ]),
...
}script$g.render = render$g;var conditionalWatch = (ref, cb, options) => {
    if (ref && ref.value !== undefined)
        return vue.watch(ref, cb, options);
    else
        return null;
...
function enableAutoResizeWithEventListener(watchedRef, autoResizeDelay) {
    const instance = vue.getCurrentInstance();
    const result = vue.reactive(new DOMRect(0, 0, 0, 0).toJSON());
    if (instance) {
...
const mountMap = (props, vmb_map, mapContainerRef, rootContainerRef) => (() => {
    ...
    if (props.touchZoomRotate) {
        enableTouchZoomRotate(map, vue.toRef(props, 'touchZoomRotate'));
    }
})();
...
function mapWatcher(vmb_map, props, propsReactive) {
    return __awaiter(this, void 0, void 0, function* () {
        const { cooperativeGestures, width, height, bearing, maxBounds, maxPitch, minZoom, maxZoom, minPitch, pitch, projection, renderWorldCopies, zoom, mapStyle } = vue.toRefs(props);
...
function watchMapStyle(vmb_map, mapStyle) {
    return __awaiter(this, void 0, void 0, function* () {
        const map = yield vmb_map.promise;
        vue.watch(mapStyle, (newStyle) => map.setStyle(newStyle));
    });
}
function watchDimensions(vmb_map, width, height) {
    return __awaiter(this, void 0, void 0, function* () {
        const map = yield vmb_map.promise;
        vue.watch(width, () => map.resize());
        vue.watch(height, () => map.resize());
    });
}
...
const registerMapEvents = (vmb_map, instance) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const internal = vue.ref(instance.props[modelName] || propertyValue);
    for (const eventName of eventNames)
        vue.watch(internal, _val => {
            instance.emit(eventName, internal.value);
        });
    vue.watch(instance.props, () => {
        if (isPrimitive(instance.props[modelName])
            ? instance.props[modelName] !== internal.value
            : !equal__default["default"](instance.props[modelName], internal.value))
    ...
    setup: (props) => {
        ...
        const vmb_map = new Deferred__default$1["default"]();
        ...
        const style = vue.ref(getStyle(props));
        vue.watch(props, (p) => __awaiter(void 0, void 0, void 0, function* () {
            updateStyle(p, style);
        }));
        ...
        vue.onUnmounted(() => __awaiter(void 0, void 0, void 0, function* () {
            const map = yield vmb_map.promise;
            map.remove();
        }));
        return {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", {
    ...
    (_ctx.vmb_map.isResolved)
      ? (vue.openBlock(), vue.createElementBlock("div", {
          ...
          ref: "mapContainer",
          class: "map-container",
          style: vue.normalizeStyle({ height: _ctx.height, width: _ctx.width })
        }, null, 4))
...
styleInject(css_248z);script$f.render = render$f;
script$f.__scopeId = "data-v-55cc3ed8";var injectMap = {
    setup() {
        const vmb_map = vue.inject('vmb_map', null);
        return { vmb_map };
    },
...
const mountMarker = (options, vmb_map, vmb_marker, instance, lngLat, element) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    setup(props) {
        ...
        const vmb_marker = new Deferred__default["default"]();
        ...
        vue.watch(props, (p) => __awaiter(this, void 0, void 0, function* () {
...
const _hoisted_4 = /*#__PURE__*/vue.createStaticVNode("<g transform=\"translate(3.0, 29.0)\" fill=\"#000000\"><ellipse opacity=\"0.04\" cx=\"10.5\" cy=\"5.80029008\" rx=\"10.5\" ry=\"5.25002273\"></ellipse><ellipse opacity=\"0.04\" cx=\"10.5\" cy=\"5.80029008\" rx=\"10.5\" ry=\"5.25002273\"></ellipse><ellipse opacity=\"0.04\" cx=\"10.5\" cy=\"5.80029008\" rx=\"9.5\" ry=\"4.77275007\"></ellipse><ellipse opacity=\"0.04\" cx=\"10.5\" cy=\"5.80029008\" rx=\"8.5\" ry=\"4.29549936\"></ellipse><ellipse opacity=\"0.04\" cx=\"10.5\" cy=\"5.80029008\" rx=\"7.5\" ry=\"3.81822308\"></ellipse><ellipse opacity=\"0.04\" cx=\"10.5\" cy=\"5.80029008\" rx=\"6.5\" ry=\"3.34094679\"></ellipse><ellipse opacity=\"0.04\" cx=\"10.5\" cy=\"5.80029008\" rx=\"5.5\" ry=\"2.86367051\"></ellipse><ellipse opacity=\"0.04\" cx=\"10.5\" cy=\"5.80029008\" rx=\"4.5\" ry=\"2.38636864\"></ellipse></g>", 1);
const _hoisted_5 = ["fill"];
const _hoisted_6 = /*#__PURE__*/vue.createElementVNode("path", { d: "M27,13.5 C27,19.074644 20.250001,27.000002 14.75,34.500002 C14.016665,35.500004 12.983335,35.500004 12.25,34.500002 C6.7499993,27.000002 0,19.222562 0,13.5 C0,6.0441559 6.0441559,0 13.5,0 C20.955844,0 27,6.0441559 27,13.5 Z" }, null, -1);
const _hoisted_7 = [
  _hoisted_6
];
const _hoisted_8 = /*#__PURE__*/vue.createStaticVNode("<g opacity=\"0.25\" fill=\"#000000\"><path d=\"M13.5,0 C6.0441559,0 0,6.0441559 0,13.5 C0,19.222562 6.7499993,27 12.25,34.5 C13,35.522727 14.016664,35.500004 14.75,34.5 C20.250001,27 27,19.074644 27,13.5 C27,6.0441559 20.955844,0 13.5,0 Z M13.5,1 C20.415404,1 26,6.584596 26,13.5 C26,15.898657 24.495584,19.181431 22.220703,22.738281 C19.945823,26.295132 16.705119,30.142167 13.943359,33.908203 C13.743445,34.180814 13.612715,34.322738 13.5,34.441406 C13.387285,34.322738 13.256555,34.180814 13.056641,33.908203 C10.284481,30.127985 7.4148684,26.314159 5.015625,22.773438 C2.6163816,19.232715 1,15.953538 1,13.5 C1,6.584596 6.584596,1 13.5,1 Z\"></path></g><g transform=\"translate(6.0, 7.0)\" fill=\"#FFFFFF\"></g><g transform=\"translate(8.0, 8.0)\"><circle fill=\"#000000\" opacity=\"0.25\" cx=\"5.5\" cy=\"5.5\" r=\"5.4999962\"></circle><circle fill=\"#FFFFFF\" cx=\"5.5\" cy=\"5.5\" r=\"5.4999962\"></circle></g>", 3);
      ...
      vue.renderSlot(_ctx.$slots, "icon", {}, () => [
        (vue.openBlock(), vue.createElementBlock("svg", {
          ...
          vue.createElementVNode("g", _hoisted_3, [
            _hoisted_4,
            vue.createElementVNode("g", { fill: _ctx.color }, _hoisted_7, 8, _hoisted_5),
            _hoisted_8
          ])
        ], 8, _hoisted_2))
      ])
...
}script$e.render = render$e;const getNavigationControlOptions = (props) => {
...
const mountNavigationControl = (nav, vmb_map, position) => (() => __awaiter(void 0, void 0, void 0, function* () {
  ...
  return (vue.openBlock(), vue.createElementBlock("div"))
}script$d.render = render$d;const removeLayerIfPresent = (id, map) => {
...
const updatePopup = (props, vmb_popup) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    setup(props) {
        ...
        const vmb_paint = vue.inject('vmb_geogeometry_paint', null);
...
}script$c.render = render$c;const getAttributionControlOptions = (props) => filterObject(props);
const mountAttributionControl = (vmb_map, vmb_attributionControl) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  return (vue.openBlock(), vue.createElementBlock("div"))
}script$b.render = render$b;const getScaleControlOptions = (props) => {
...
const mountScaleControl = (vmb_map, vmb_scaleControl) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  return (vue.openBlock(), vue.createElementBlock("div"))
}script$a.render = render$a;const getFullscreenControlOptions = (props) => filterObject(props);
const mountFullscreenControl = (vmb_fullscreenControl, vmb_map) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  return (vue.openBlock(), vue.createElementBlock("div"))
}script$9.render = render$9;const getDrawControlOptions = (props) => filterObject(props, ['position']);
...
const mountDrawControl = (vmb_map, vmb_drawControl, opts, component) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    setup(props) {
        ...
        const vmb_drawControl = new MapboxDrawControl__default["default"]();
        const vmb_map = vue.inject('vmb_map', null);
        vue.onMounted(() => __awaiter(this, void 0, void 0, function* () {
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
...
}script$7.render = render$7;const getGeolocationControlOptions = (props) => filterObject(props);var script$6 = vue.defineComponent({
  ...
  return (vue.openBlock(), vue.createElementBlock("div"))
}script$6.render = render$6;class Geogeometry {
    constructor(input) {
        this.id = input.id;
        ...
        this.deferred = new Deferred__default["default"]();
        vue.provide('vmb_geogeometry', this.deferred);
    }
    updateOptions(input) {
        if (input.fillColor)
    ...
    constructor(input) {
        ...
        this.deferred = new Deferred__default["default"]();
        vue.provide('vmb_geogeometry_paint', this.deferred);
    }
    _init(paintType, id) {
        return __awaiter(this, void 0, void 0, function* () {
...
class GeogeometryFill extends GeogeometryPaint {
    ...
    setup(props) {
        const vmb_geogeometry = vue.inject('vmb_geogeometry', null);
        const vmb_fill = new Deferred__default["default"]();
        const vmb_map = vue.inject('vmb_map', null);
        if (!vmb_geogeometry)
...
}script$5.render = render$5;let circlesAdded = 0;
var script$4 = vue.defineComponent({
    ...
    setup(props) {
        const vmb_map = vue.inject('vmb_map', null);
        const vmb_circle = new Deferred__default$1["default"]();
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_mapbox_geogeometry_fill = vue.resolveComponent("mapbox-geogeometry-fill");

  return (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$3, [
    vue.renderSlot(_ctx.$slots, "default", {}, () => [
      vue.createVNode(_component_mapbox_geogeometry_fill, {
...
}script$4.render = render$4;class Polygon extends Geogeometry {
    constructor(input) {
        super(input);
...
var script$3 = vue.defineComponent({
    ...
    setup(props) {
        const vmb_map = vue.inject('vmb_map', null);
        const vmb_polygon = new Deferred__default$1["default"]();
...
}script$3.render = render$3;const rotateRectangle = (coords, angleDeg) => {
    if (coords.length !== 4)
...
var script$2 = vue.defineComponent({
    ...
    setup(props) {
        const vmb_map = vue.inject('vmb_map', null);
        const vmb_rectangle = new Deferred__default$1["default"]();
...
}script$2.render = render$2;const pathIsClosed = (pos) => {
    if (pos.length <= 1)
        return false;
    else {
...
var script$1 = vue.defineComponent({
    ...
    setup(props) {
        const vmb_map = vue.inject('vmb_map', null);
        const vmb_raw = new Deferred__default["default"]();
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  vue.resolveComponent("mapbox-geogeometry-fill");
...
}script$1.render = render$1;let linesAdded = 0;
class GeogeometryLine extends GeogeometryPaint {
    ...
    update(props, vmb_map) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.id) {
                ...
                if (opts.dasharray && !equal__default["default"](this.dasharray, opts.dasharray)) {
    ...
    setup(props) {
        const vmb_geogeometry = vue.inject('vmb_geogeometry', null);
        const vmb_line = new Deferred__default["default"]();
        const vmb_map = vue.inject('vmb_map', null);
        vue.provide('vmb_paint', vmb_line);
        if (!vmb_geogeometry)
  ...
  return (vue.openBlock(), vue.createElementBlock("div"))
}script.render = render;// export default {
//   // MapboxGeocoder,
//   // MapboxImage,
//   // MapboxImages,
//   // MapboxLayer,
...
// };
var components=/*#__PURE__*/Object.freeze({__proto__:null,MapboxGeocoderControl:script$g,MapboxMap:script$f,MapboxMarker:script$e,MapboxNavigationControl:script$d,MapboxPopup:script$c,MapboxAttributionControl:script$b,MapboxScaleControl:script$a,MapboxFullscreenControl:script$9,MapboxDrawControl:script$8,MapboxSourceGeoJson:script$7,MapboxGeolocateControl:script$6,MapboxGeogeometryCircle:script$4,MapboxGeogeometryPolygon:script$3,MapboxGeogeometryRectangle:script$2,MapboxGeogeometryRaw:script$1,MapboxGeogeometryFill:script$5,MapboxGeogeometryLine:script});// import { VueConstructor } from 'vue';
...
}exports.Animation=Animation;exports.MapboxAttributionControl=script$b;exports.MapboxDrawControl=script$8;exports.MapboxFullscreenControl=script$9;exports.MapboxGeocoderControl=script$g;exports.MapboxGeogeometryCircle=script$4;exports.MapboxGeogeometryFill=script$5;exports.MapboxGeogeometryLine=script;exports.MapboxGeogeometryPolygon=script$3;exports.MapboxGeogeometryRaw=script$1;exports.MapboxGeogeometryRectangle=script$2;exports.MapboxGeolocateControl=script$6;exports.MapboxMap=script$f;exports.MapboxMarker=script$e;exports.MapboxNavigationControl=script$d;exports.MapboxPopup=script$c;exports.MapboxScaleControl=script$a;exports.MapboxSourceGeoJson=script$7;exports["default"]=install;